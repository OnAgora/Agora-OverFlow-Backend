...
pub fun main(address: Address, id: UInt64): NFT {
    ...
    let collection = account
        .getCapability(YoungApeDiaries.CollectionPublicPath)
        .borrow<&{YoungApeDiaries.YoungApeDiariesCollectionPublic}>()
        ?? panic("Could not borrow a reference to the collection")

    let nft = collection.borrowYoungApeDiaries(id: id)!
